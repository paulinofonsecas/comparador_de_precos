...
class LogistaProdutosAssociadosBloc extends Bloc<LogistaProdutosAssociadosEvent,
    LogistaProdutosAssociadosState> {
  LogistaProdutosAssociadosBloc()
      : super(const LogistaProdutosAssociadosInitial()) {
    on<CustomLogistaProdutosAssociadosEvent>(
      _onCustomLogistaProdutosAssociadosEvent,
    );
  }
